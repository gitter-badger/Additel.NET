...
namespace Additel.Controls
{
    public partial class Switch : SKCanvasView
    {
        ...
        private SKColor _trackColor = SKColors.GrayBackground;
        ...
        protected override void OnPaintSurface(SKSurface surface, SKImageInfo info)
        {
            ...
            using (var paint = new SKPaint())
            {
                ...
                // 阴影
                paint.Color = SKColors.GrayShadow;
                ...
                case SKTouchAction.Moved:
                    {
                        ...
                        else if (_touchValue && -distance > max)
                        {
                            ...
                            TrackColor = SKColors.GrayBackground;
                            BackwardThumb();
        ...
        private void OnStateChanged()
        {
            ...
            StateChanged?.Invoke(this, new SwitchStateEventArgs(State));
        }
